...
const AMAZON_URI = 'https://www.amazon.com/dp/B08FC6MR62';
const AMAZON_NO_STOCK = 'Currently unavailable';
const VENDOR = [
...
function parseResponse(name, url, out_of_stock_string, response) {
